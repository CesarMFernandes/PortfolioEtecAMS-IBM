...
call videos_de_produtoras(4); -- id da produtora
...
/*Adicionar uma série*/
call adicionar_series("JoJo no Kimyou na Bouken"); -- Nome da série

/*Colocar gêneros de uma série*/
call colocar_generos_series(1, "Ação"); -- Id da série, gênero
call colocar_generos_series(1, "Comédia");

/*Adicionar temporadas*/
call adicionar_temporadas("Phantom Blood / Battle Tendency", 1, 1); -- Nome da temporada (opcional), id da série
call adicionar_temporadas("Stardust Crusaders", 2, 1);

/*Adicionar Episodios*/
call adicionar_episodios("Dio, o Invasor", 1440, 1, 1); -- Nome do episódio, duração
